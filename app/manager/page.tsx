    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {insights && insights.insights && insights.insights.length > 0 && (
          <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl shadow-xl p-6 mb-8 text-white animate-fade-in-up backdrop-blur-xl hover:shadow-glow transition-all duration-300">
            <div className="flex items-start gap-3">
              <div className="bg-white/20 p-2 rounded-lg flex-shrink-0 animate-pulse-slow" aria-hidden="true">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-1">
                  {insights.insights.slice(0, 3).map((insight: any, idx: number) => (
                    <div key={idx} className="text-white/90 text-sm animate-slide-in-right" style={{ animationDelay: `${idx * 0.1}s` }}>• {insight.message}</div>
                  ))}
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 card-hover animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center justify-between">
              ...
              <div className="bg-indigo-100 p-3 rounded-xl transition-transform duration-300 hover:scale-110" aria-hidden="true">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 card-hover animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="bg-green-100 p-3 rounded-xl transition-transform duration-300 hover:scale-110" aria-hidden="true">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 card-hover animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="bg-amber-100 p-3 rounded-xl transition-transform duration-300 hover:scale-110" aria-hidden="true">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 card-hover animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="bg-red-100 p-3 rounded-xl transition-transform duration-300 hover:scale-110 animate-pulse-slow" aria-hidden="true">
              ...
              {[
                ...
                <button
                  ...
                  className={`px-6 py-4 text-sm font-medium border-b-2 transition-all duration-300 ${
                    activeTab === tab.key
                      ? 'border-indigo-500 text-indigo-600 bg-indigo-50/50 scale-105'
